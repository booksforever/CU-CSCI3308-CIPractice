...
START_TEST(test_area_triangle)
{
	...
	double actual1 = coord_2d_area_triangle(&a, &b, &c);
	ck_assert(actual1==(0.0));
	...
	double actual2 = coord_2d_area_triangle(&a, &b, &c);
	ck_assert(actual2==(10.0));
	...
	double actual3 = coord_2d_area_triangle(&a, &b, &c);
	ck_assert(actual3=(340.5));
